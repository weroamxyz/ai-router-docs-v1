...
This document provides methods and best practices for updating the ComputeVault system to ensure a smooth upgrade to the latest version.
...
If you have deployed ComputeVault using a single Docker container, you can update by following these steps:
...
2.  Find the ComputeVault application and click the **Upgrade** button
...
2.  Find the ComputeVault container, click **More** -> **Recreate**
...
If you have deployed ComputeVault by compiling from source code, the update steps are as follows:
