...
This document provides methods and best practices for updating the Unode system to ensure a smooth upgrade to the latest version.
...
If you have deployed Unode using a single Docker container, you can update by following these steps:
...
2.  Find the Unode application and click the **Upgrade** button
...
2.  Find the Unode container, click **More** -> **Recreate**
...
If you have deployed Unode by compiling from source code, the update steps are as follows:
