...
This document provides detailed configuration steps and best practices for ((BRAND)) cluster deployment, helping you build a highly available, load-balanced distributed system.
...
The ((BRAND)) cluster adopts a master-slave architecture design:
