...
This document provides a graphical tutorial for deploying ((BRAND)) using the 1Panel panel.
...
## Step 2: Install ((BRAND))

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the ((BRAND)) application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure ((BRAND)) application parameters on the installation page:
</Callout>

- **Name**: The name of the ((BRAND)) application to be created
- **Version**: Select the version of ((BRAND))
- **Port**: The service port for the ((BRAND)) application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the ((BRAND)) application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the ((BRAND)) application
...
<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the ((BRAND)) WebUI page
...
2. Find the ((BRAND)) application, click the **Upgrade** button
