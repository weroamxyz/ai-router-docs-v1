...
This document provides a graphical tutorial for deploying ComputeVault using the 1Panel panel.
...
## Step 2: Install ComputeVault

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the ComputeVault application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure ComputeVault application parameters on the installation page:
</Callout>

- **Name**: The name of the ComputeVault application to be created
- **Version**: Select the version of ComputeVault
- **Port**: The service port for the ComputeVault application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the ComputeVault application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the ComputeVault application
...
## Step 4: Access ComputeVault

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the ComputeVault WebUI page
...
2. Find the ComputeVault application, click the **Upgrade** button
