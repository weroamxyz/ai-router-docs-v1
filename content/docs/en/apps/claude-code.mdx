---
title: Claude Code
description: Claude Code configuration guide — use Anthropic's terminal-based coding agent with ((BRAND)). Supports code understanding, multi-file editing, and IDE integration.
---
