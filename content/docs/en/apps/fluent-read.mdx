...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to Unode for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Unode console, you can add
...
### Import Configuration from Unode Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Unode console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Unode configuration in FluentRead will be enabled.
