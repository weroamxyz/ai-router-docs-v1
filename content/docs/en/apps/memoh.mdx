...
description: Memoh integration guide — Connect the self-hosted containerized AI agent platform to ((BRAND)), creating AI bots with long-term memory for Telegram, Discord, Lark, QQ, WeChat, and more.
---
