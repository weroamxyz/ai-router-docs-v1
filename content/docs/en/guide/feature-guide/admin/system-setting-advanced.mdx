...
Ratio settings are the core configuration of the ((BRAND)) billing system. By setting different Ratios, you can flexibly control the billing standards for various models and user groups.

### Ratio System Overview

((BRAND)) uses a three-tier Ratio system to calculate user Quota consumption:
...
((BRAND)) employs a dual billing mechanism of pre-consumption and post-consumption:
