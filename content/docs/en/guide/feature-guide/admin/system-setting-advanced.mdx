...
Ratio settings are the core configuration of the Unode billing system. By setting different Ratios, you can flexibly control the billing standards for various models and user groups.

### Ratio System Overview

Unode uses a three-tier Ratio system to calculate user Quota consumption:
...
Unode employs a dual billing mechanism of pre-consumption and post-consumption:
