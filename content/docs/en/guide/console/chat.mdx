...
ComputeVault provides quick access to several AI chat applications, making them convenient for testing or use.

## Import Configuration

You can import configurations into chat applications with one click on the Console -> API Tokens page.

![One-click Import](/assets/guide-en/import-chat-config.png)
...
<Callout type="warn">
  ...
  ComputeVault; manual entry is required.
</Callout>

Configuration Entry
![lobechat-1](/assets/guide-en/lobechat-1.png)
![lobechat-2](/assets/guide-en/lobechat-2.png)
...
<Callout type="info">
  Supports one-click configuration import from ComputeVault
</Callout>
