...
((BRAND)) provides quick access to several AI chat applications, making them convenient for testing or use.
...
<Callout type="warn">
  ...
  ((BRAND)); manual entry is required.
</Callout>
...
<Callout type="info">
  Supports one-click configuration import from ((BRAND))
</Callout>
