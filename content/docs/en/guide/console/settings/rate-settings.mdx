...
#### Audio Models (Special handling, automatically processed internally by ComputeVault)
...
ComputeVault adopts a dual billing mechanism of pre-consumption and post-consumption:
