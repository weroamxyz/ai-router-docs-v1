...
In the Unode system, ratios are key parameters for calculating quota consumption. Quota is the internal billing unit of the system, and all API calls are ultimately converted into quota points for deduction.
...
#### Audio Models (Special handling, automatically processed internally by Unode)
...
Unode adopts a dual billing mechanism of pre-consumption and post-consumption:
...
![倍率1](/assets/guide-en/rate-setting-1.png)
...
![倍率2](/assets/guide-en/rate-setting-2.png)
...
![倍率3](/assets/guide-en/rate-setting-3.png)
...
![倍率4](/assets/guide-en/rate-setting-4.png)
...
![倍率5](/assets/guide-en/rate-setting-5.png)
