...
| `size` | string | No | The resolution of the output image, in the format of width*height. The default resolution is 1328*1328. Available options and their corresponding aspect ratios:<br />- `"1664*928"` (16:9)<br />- `"1472*1140"` (4:3)<br />- `"1328*1328"` (1:1, default)<br />- `"1140*1472"` (3:4)<br />- `"928*1664"` (9:16) |
