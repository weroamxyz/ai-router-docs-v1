...
| **claude-sonnet-4-5** | Claude Sonnet 4.5 chat model (previous generation) |
| **claude-sonnet-4-6** | Claude Sonnet 4.6 chat model (previous generation) |
| **claude-sonnet-5** | The best combination of speed and intelligence |
| **claude-opus-4-5** | Claude Opus 4.5 chat model (previous generation) |
| **claude-opus-4-6** | Claude Opus 4.6 chat model (previous generation) |
| **claude-opus-4-7** | Claude Opus 4.7 chat model (previous generation) |
| **claude-opus-4-8** | Claude Opus 4.8 chat model (previous generation) |
| **claude-opus-5** | For complex agentic coding and enterprise work |
| **claude-fable-5** | Next-generation intelligence for long-running agents; Anthropic's most capable widely released model |
