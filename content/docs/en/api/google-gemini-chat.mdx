...
| Model | Description |
| --- | --- |
| **gemini-1.5-pro** | Gemini 1.5 Pro chat model |
| **gemini-1.5-flash** | Gemini 1.5 Flash chat model |
| **gemini-1.5-flash-8b** | Gemini 1.5 Flash 8B chat model |
| **gemini-1.5-pro-latest** | Gemini 1.5 Pro chat model (latest version) |
| **gemini-1.5-flash-latest** | Gemini 1.5 Flash chat model (latest version) |
| **gemini-2.0-flash** | Gemini 2.0 Flash chat model |
| **gemini-2.0-flash-lite-preview** | Gemini 2.0 Flash Lite chat model (preview) |
| **gemini-2.0-flash-exp** | Gemini 2.0 Flash chat model (experimental) |
| **gemini-2.0-pro-exp** | Gemini 2.0 Pro chat model (experimental) |
| **gemini-2.0-flash-thinking-exp** | Gemini 2.0 Flash Thinking chat model (experimental) |
| **gemini-2.5-flash** | Gemini 2.5 Flash chat model |
| **gemini-2.5-pro** | Gemini 2.5 Pro chat model |
| **gemini-3-pro-preview** | Gemini 3 Pro chat model (preview) |
| **gemini-3-flash-preview** | Gemini 3 Flash chat model (preview) |
