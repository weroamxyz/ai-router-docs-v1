...
| **gemini-3.1-flash-image-preview** | Google Gemini fast image generation model (preview) |
...
| **imagen-4.0-fast-generate-001** | Google Imagen 4.0 Fast image generation model |
