...
| Model | Description |
| --- | --- |
| **text-embedding-ada-002** | Ada text embedding model (1536 dimensions) |
| **text-embedding-3-small** | Small text embedding model (1536 dimensions) |
| **text-embedding-3-large** | Large text embedding model (3072 dimensions) |
...
```bash
curl https://www.unodetech.xyz/v1/embeddings \
