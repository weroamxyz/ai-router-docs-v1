...
<Callout type="info" title="JSON image-edit requests">
...
| `size` | string | No | Size of the generated image. Standard options: `1024x1024`, `1536x1024` (horizontal), `1024x1536` (vertical), `auto`. `gpt-image-2` and both GPT Image 2.5 variants also accept custom `WIDTHxHEIGHT` strings; see [Custom dimensions](#custom-dimensions). Default: `auto`. |
