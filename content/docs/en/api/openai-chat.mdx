...
| --- | --- | --- |
| **gpt-3.5-turbo** | GPT-3.5 Turbo chat model | ✅ Available |
| **gpt-3.5-turbo-16k** | GPT-3.5 Turbo chat model (16K context) | ⚠️ Temporarily Unavailable |
| **gpt-3.5-turbo-instruct** | GPT-3.5 Turbo instruct model | ⚠️ Temporarily Unavailable |
| **gpt-4** | GPT-4 chat model | ⚠️ Temporarily Unavailable |
| **gpt-4-32k** | GPT-4 chat model (32K context) | ⚠️ Temporarily Unavailable |
| **gpt-4-turbo-preview** | GPT-4 Turbo chat model (preview) | ⚠️ Temporarily Unavailable |
| **gpt-4-turbo** | GPT-4 Turbo chat model | ⚠️ Temporarily Unavailable |
| **gpt-4-vision-preview** | GPT-4 Vision chat model (preview) | ⚠️ Temporarily Unavailable |
| **gpt-4o** | GPT-4o chat model | ✅ Available |
| **gpt-4o-mini** | GPT-4o Mini chat model | ✅ Available |
| **gpt-4.5-preview** | GPT-4.5 chat model (preview) | ⚠️ Temporarily Unavailable |
| **gpt-4.1** | GPT-4.1 chat model | ✅ Available |
| **gpt-4.1-mini** | GPT-4.1 Mini chat model | ✅ Available |
| **gpt-4.1-nano** | GPT-4.1 Nano chat model | ✅ Available |
| **gpt-5** | GPT-5 chat model | ✅ Available |
| **gpt-5-chat-latest** | GPT-5 chat model (latest version) | ✅ Available |
| **gpt-5-mini** | GPT-5 Mini chat model | ✅ Available |
| **gpt-5-nano** | GPT-5 Nano chat model | ✅ Available |
...
```bash
curl https://computevault.unodetech.xyz/v1/chat/completions \
