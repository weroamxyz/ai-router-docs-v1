...
| **gpt-4o-audio-preview** | GPT-4o chat model with native audio input/output support |
| **gpt-4.1** | Smartest non-reasoning model |
| **gpt-4.1-mini** | A streamlined, faster alternative to GPT-4.1 |
| **gpt-4.1-nano** | The fastest, most cost-effective model in the GPT-4.1 family |
| **gpt-5** | Previous intelligent reasoning model for coding and agentic tasks |
| **gpt-5-chat-latest** | GPT-5 chat model that always points to the latest snapshot |
| **gpt-5-mini** | Strong performance for cost-conscious, latency-sensitive applications |
| **gpt-5-nano** | The fastest and most economical GPT-5 variant |
| **gpt-5.1** | Top performer for coding with configurable reasoning capabilities |
| **gpt-5.2** | Frontier model supporting adjustable reasoning intensity |
| **gpt-5.4** | A more economical alternative within the GPT-5 family for coding work |
| **gpt-5.4-mini** | OpenAI's strongest mini model yet for coding, computer use, and subagents |
| **gpt-5.5** | A new intelligence tier tailored for coding and professional applications |
| **gpt-5.6-luna** | GPT-5.6 model optimized for cost-sensitive workloads |
| **gpt-5.6-terra** | Balances capability with affordability as the mid-tier option in the 5.6 lineup |
