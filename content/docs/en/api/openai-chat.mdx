...
| **gpt-4o-audio-preview** | GPT-4o Audio chat model |
...
| **gpt-5.1** | GPT-5.1 chat model |
| **gpt-5.2** | GPT-5.2 chat model |
| **gpt-5.4** | GPT-5.4 chat model |
| **gpt-5.4-mini** | GPT-5.4 Mini chat model |
| **gpt-5.5** | GPT-5.5 chat model |
...
```bash
curl https://www.unodetech.xyz/v1/chat/completions \
