...
| Model | Description |
| --- | --- |
| **gpt-3.5-turbo** | GPT-3.5 Turbo chat model |
| **gpt-3.5-turbo-16k** | GPT-3.5 Turbo chat model (16K context) |
| **gpt-3.5-turbo-instruct** | GPT-3.5 Turbo instruct model |
| **gpt-4** | GPT-4 chat model |
| **gpt-4-32k** | GPT-4 chat model (32K context) |
| **gpt-4-turbo-preview** | GPT-4 Turbo chat model (preview) |
| **gpt-4-turbo** | GPT-4 Turbo chat model |
| **gpt-4-vision-preview** | GPT-4 Vision chat model (preview) |
| **gpt-4o** | GPT-4o chat model |
| **gpt-4o-mini** | GPT-4o Mini chat model |
| **gpt-4.5-preview** | GPT-4.5 chat model (preview) |
| **gpt-4.1** | GPT-4.1 chat model |
| **gpt-4.1-mini** | GPT-4.1 Mini chat model |
| **gpt-4.1-nano** | GPT-4.1 Nano chat model |
| **gpt-5** | GPT-5 chat model |
| **gpt-5-chat-latest** | GPT-5 chat model (latest version) |
| **gpt-5-mini** | GPT-5 Mini chat model |
| **gpt-5-nano** | GPT-5 Nano chat model |
