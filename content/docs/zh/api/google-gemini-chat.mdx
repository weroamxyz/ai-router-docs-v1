...
| 模型 | 描述 |
| --- | --- |
| **gemini-1.5-pro** | Gemini 1.5 Pro 对话模型 |
| **gemini-1.5-flash** | Gemini 1.5 Flash 对话模型 |
| **gemini-1.5-flash-8b** | Gemini 1.5 Flash 8B 对话模型 |
| **gemini-1.5-pro-latest** | Gemini 1.5 Pro 对话模型（最新版本） |
| **gemini-1.5-flash-latest** | Gemini 1.5 Flash 对话模型（最新版本） |
| **gemini-2.0-flash** | Gemini 2.0 Flash 对话模型 |
| **gemini-2.0-flash-lite-preview** | Gemini 2.0 Flash Lite 对话模型（预览版） |
| **gemini-2.0-flash-exp** | Gemini 2.0 Flash 对话模型（实验版） |
| **gemini-2.0-pro-exp** | Gemini 2.0 Pro 对话模型（实验版） |
| **gemini-2.0-flash-thinking-exp** | Gemini 2.0 Flash Thinking 对话模型（实验版） |
| **gemini-2.5-flash** | Gemini 2.5 Flash 对话模型 |
| **gemini-2.5-pro** | Gemini 2.5 Pro 对话模型 |
| **gemini-3-pro-preview** | Gemini 3 Pro 对话模型（预览版） |
| **gemini-3-flash-preview** | Gemini 3 Flash 对话模型（预览版） |
