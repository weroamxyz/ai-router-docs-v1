...
<Callout type="warn" title="模型可用性">
标有 ⚠️ 的模型当前暂不可用（无可用渠道）。建议使用未标注的模型。渠道可用性未来可能恢复。
</Callout>

| 模型 | 描述 | 状态 |
| --- | --- | --- |
| **gemini-1.5-pro** | Gemini 1.5 Pro 对话模型 | ⚠️ 暂不可用 |
| **gemini-1.5-flash** | Gemini 1.5 Flash 对话模型 | ⚠️ 暂不可用 |
| **gemini-1.5-flash-8b** | Gemini 1.5 Flash 8B 对话模型 | ⚠️ 暂不可用 |
| **gemini-1.5-pro-latest** | Gemini 1.5 Pro 对话模型（最新版本） | ⚠️ 暂不可用 |
| **gemini-1.5-flash-latest** | Gemini 1.5 Flash 对话模型（最新版本） | ⚠️ 暂不可用 |
| **gemini-2.0-flash** | Gemini 2.0 Flash 对话模型 | ⚠️ 暂不可用 |
| **gemini-2.0-flash-lite-preview** | Gemini 2.0 Flash Lite 对话模型（预览版） | ⚠️ 暂不可用 |
| **gemini-2.0-flash-exp** | Gemini 2.0 Flash 对话模型（实验版） | ⚠️ 暂不可用 |
| **gemini-2.0-pro-exp** | Gemini 2.0 Pro 对话模型（实验版） | ⚠️ 暂不可用 |
| **gemini-2.0-flash-thinking-exp** | Gemini 2.0 Flash Thinking 对话模型（实验版） | ⚠️ 暂不可用 |
| **gemini-2.5-flash** | Gemini 2.5 Flash 对话模型 | ✅ 可用 |
| **gemini-2.5-pro** | Gemini 2.5 Pro 对话模型 | ✅ 可用 |
| **gemini-3-pro-preview** | Gemini 3 Pro 对话模型（预览版） | ✅ 可用 |
| **gemini-3-flash-preview** | Gemini 3 Flash 对话模型（预览版） | ✅ 可用 |
...
格式：`models/{model}`，例如 `models/gemini-3-pro-preview`
