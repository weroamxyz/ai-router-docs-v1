...
| 模型 | 描述 |
| --- | --- |
| **claude-haiku-4-5** | Claude Haiku 4.5 对话模型 |
| **claude-sonnet-4-5** | Claude Sonnet 4.5 对话模型 |
| **claude-sonnet-4-6** | Claude Sonnet 4.6 对话模型 |
| **claude-opus-4-5** | Claude Opus 4.5 对话模型 |
| **claude-opus-4-6** | Claude Opus 4.6 对话模型 |
| **claude-opus-4-7** | Claude Opus 4.7 对话模型 |
| **claude-opus-4-8** | Claude Opus 4.8 对话模型 |
...
```bash
curl https://www.unodetech.xyz/v1/messages \
