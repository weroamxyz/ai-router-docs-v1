...
| **qwen3.5-flash** | Qwen 3.5 Flash 对话模型 |
| **qwen3.5-plus** | Qwen 3.5 Plus 对话模型 |
| **qwen3.6-plus** | Qwen 3.6 Plus 对话模型 |
| **qwen3.7-max** | Qwen 3.7 Max 对话模型 |
...
```bash
curl --location "https://www.unodetech.xyz/api/v1/services/aigc/text-generation/generation" \
