...
| 模型 | 描述 | 状态 |
| --- | --- | --- |
| **gpt-3.5-turbo** | GPT-3.5 Turbo 对话模型 | ✅ 可用 |
| **gpt-3.5-turbo-16k** | GPT-3.5 Turbo 对话模型（16K上下文） | ⚠️ 暂不可用 |
| **gpt-3.5-turbo-instruct** | GPT-3.5 Turbo 指令模型 | ⚠️ 暂不可用 |
| **gpt-4** | GPT-4 对话模型 | ⚠️ 暂不可用 |
| **gpt-4-32k** | GPT-4 对话模型（32K上下文） | ⚠️ 暂不可用 |
| **gpt-4-turbo-preview** | GPT-4 Turbo 对话模型（预览版） | ⚠️ 暂不可用 |
| **gpt-4-turbo** | GPT-4 Turbo 对话模型 | ⚠️ 暂不可用 |
| **gpt-4-vision-preview** | GPT-4 视觉对话模型（预览版） | ⚠️ 暂不可用 |
| **gpt-4o** | GPT-4o 对话模型 | ✅ 可用 |
| **gpt-4o-mini** | GPT-4o Mini 对话模型 | ✅ 可用 |
| **gpt-4.5-preview** | GPT-4.5 对话模型（预览版） | ⚠️ 暂不可用 |
| **gpt-4.1** | GPT-4.1 对话模型 | ✅ 可用 |
| **gpt-4.1-mini** | GPT-4.1 Mini 对话模型 | ✅ 可用 |
| **gpt-4.1-nano** | GPT-4.1 Nano 对话模型 | ✅ 可用 |
| **gpt-5** | GPT-5 对话模型 | ✅ 可用 |
| **gpt-5-chat-latest** | GPT-5 对话模型（最新版本） | ✅ 可用 |
| **gpt-5-mini** | GPT-5 Mini 对话模型 | ✅ 可用 |
| **gpt-5-nano** | GPT-5 Nano 对话模型 | ✅ 可用 |
