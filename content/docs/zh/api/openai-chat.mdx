...
| **gpt-4o-mini** | 快速、经济实惠的小型模型，适用于专注型任务 |
| **gpt-4o-audio-preview** | 支持原生音频输入/输出的 GPT-4o 对话模型 |
| **gpt-4.1** | 最智能的非推理模型 |
| **gpt-4.1-mini** | 比 GPT-4.1 更精简、更快速的替代方案 |
| **gpt-4.1-nano** | GPT-4.1 系列中速度最快、性价比最高的模型 |
| **gpt-5** | 用于编码和智能体任务的上一代智能推理模型 |
| **gpt-5-chat-latest** | 始终指向最新快照的 GPT-5 对话模型 |
| **gpt-5-mini** | 在成本敏感、低延迟场景下表现出色 |
| **gpt-5-nano** | GPT-5 系列中速度最快、最经济的版本 |
| **gpt-5.1** | 在编码方面表现最佳，支持可调节的推理能力 |
| **gpt-5.2** | 支持可调节推理强度的前沿模型 |
| **gpt-5.4** | GPT-5 系列中更经济实惠的编码替代方案 |
| **gpt-5.4-mini** | OpenAI 迄今为止在编码、计算机使用和子智能体方面最强的 mini 模型 |
| **gpt-5.5** | 面向编码和专业应用打造的全新智能层级 |
| **gpt-5.6-luna** | 针对成本敏感型工作负载优化的 GPT-5.6 模型 |
| **gpt-5.6-terra** | 5.6 系列中的中端选项，兼顾能力与经济性 |
| **gpt-5.6-sol** | 面向复杂专业工作的前沿模型 |
